...
7) запуск Mlflow (будет доступен на http://127.0.0.1:5000/ )
```
mlflow ui
```

8) выбираем эксперимент heart_disease
...
2) запуск Mlflow (будет доступен на http://127.0.0.1:5000/ )
```
mlflow ui
```
...
3) запуск Mlflow (будет доступен на http://127.0.0.1:5000/ )
```
mlflow ui
```
